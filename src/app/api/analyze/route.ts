...
export async function POST(req: NextRequest) {
  ...
  const project = await prisma.project.create({
    data: {
      ...
      usableAreaM2: extracted.fields.usableAreaM2,
      constructionYear: extracted.fields.constructionYear,
      heatingType: extracted.fields.heatingType,
      monthlyCosts: extracted.fields.monthlyCosts,
      repairFund: extracted.fields.repairFund,
      importantFacts: extracted.fields.importantFacts,
